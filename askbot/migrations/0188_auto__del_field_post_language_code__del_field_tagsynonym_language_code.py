...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'askbot_thread', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=16),
                      keep_default=False)
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'languages': ('django.db.models.fields.CharField', [], {'default': "'zh-tw'", 'max_length': '128'}),
