...
class Thread(models.Model):
    ...
    def set_tags_language_code(self):
...
deprecated, use invalidate_cached_summary_html""")
    ...
    def invalidate_cached_summary_html(self):
        ...
        keys = map(lambda v: self.get_summary_cache_key(v))
        cache.cache.delete_many(keys)

    def get_summary_cache_key(self):
        #return 'thread-question-summary-%d-%s' % (self.id)
        return 'thread-question-summary-%s' % (self.id)
